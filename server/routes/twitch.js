...
const TWITCH_CLIENT_ID = 'y7wz53c0vdyatqahin0jhem36b711e';
const TWITCH_SECRET    = 'hq7wozhv9cmtt5j8smmddqmx4a5x2p';
const CALLBACK_URL     = 'http://34.67.130.241:3000/auth/twitch/callback';  // You can run locally with - http://localhost:3000/auth/twitch/callback
...
router.get('/auth/twitch/callback', passport.authenticate('twitch', { successRedirect: '/streamlist', failureRedirect: '/' }));
...
router.get('/getstreamlist', function(req, res) {
